...
| :--- | :--- | :--- |
| **EPIC-01** | Gerenciar Requisitos de Bolsa | Permitir a consulta, pesquisa, inclusão e edição dos requisitos e documentos comprobatórios de elegibilidade (acadêmicos, profissionais e perenes) exigidos para concessão de bolsas nas modalidades e níveis. |
...
| **EPIC-03** | Gerenciar Modalidades, Níveis e Versões | Permitir a consulta, pesquisa, criação, edição e ativação de modalidades de bolsa da FAPES, gerenciamento de versões com vigência e redução por vínculo, e configuração de níveis remuneratórios (valores, moeda e carga horária). |
