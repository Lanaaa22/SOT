...
- **Gestão Financeira e Liquidação Bancária (Back-office / GEPOF e DIRAF):** Permite à Gerência de Planejamento e Orçamento Financeiro (GEPOF) e à Diretoria Administrativa e Financeira (DIRAF) estabelecer o calendário anual de marcos (M1, M2 e M3), gerenciar bônus por modalidade, processar e autorizar as folhas de pagamento consolidadas, auditar o saldo de cotas pagas por bolsista e emitir os arquivos de remessa bancária integrados ao Banestes e ao Bandes.
...
| **EPIC-07** | Consultar Cotas Pagas | Permite aos gestores consultar o extrato e histórico de cotas de bolsas vinculadas a cada bolsista por edital e projeto, auditando parcelas pagas, saldos e vigências. |
...
* **Tela:** `Gerenciar Cotas`
  * **Funcionalidade:** `EPIC-07` (Consultar Cotas Pagas)
  * **Tela:** `Gerenciar Cotas do Bolsista`
    * **Funcionalidade:** `EPIC-07` (Consultar Cotas Pagas)
